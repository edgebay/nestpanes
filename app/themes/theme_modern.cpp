...
void ThemeModern::populate_standard_styles(const Ref<AppTheme> &p_theme, AppThemeManager::ThemeConfiguration &p_config) {
	...
	// Containers.
	{
		...
		p_theme->set_constant("separation", "MultiSplitContainer", p_config.base_margin * 0.75 * EDSCALE);
		p_theme->set_constant("autohide", "MultiSplitContainer", 1);
		p_theme->set_constant("minimum_grab_thickness", "MultiSplitContainer", p_config.base_margin * 2 * EDSCALE);
