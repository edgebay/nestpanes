...
#include "app/gui/inspector/editor_spin_slider.h"
#include "app/gui/inspector/editor_variant_type_selectors.h"
...
void EditorPropertyObjectID::update_property() {
	...
	if (id.is_valid()) {
		...
		// edit->set_button_icon(EditorNode::get_singleton()->get_class_icon(type));	// TODO
	} else {
...
bool ObjectInspectorDefaultPlugin::can_handle(Object *p_object) {
	return true; // Can handle everything.
}

bool ObjectInspectorDefaultPlugin::parse_property(Object *p_object, const Variant::Type p_type, const String &p_path, const PropertyHint p_hint, const String &p_hint_text, const BitField<PropertyUsageFlags> p_usage, const bool p_wide) {
	Control *editor = ObjectInspectorDefaultPlugin::get_editor_for_property(p_object, p_type, p_path, p_hint, p_hint_text, p_usage, p_wide);
	if (editor) {
...
static EditorProperty *get_input_action_editor(const String &p_hint_text, bool is_string_name) {
	...
	// ProjectSettings::get_singleton()->get_property_list(&pinfo);	// TODO
...
EditorProperty *ObjectInspectorDefaultPlugin::get_editor_for_property(Object *p_object, const Variant::Type p_type, const String &p_path, const PropertyHint p_hint, const String &p_hint_text, const BitField<PropertyUsageFlags> p_usage, const bool p_wide) {
