...
#define EditorInspector ObjectInspector
#define ObjectInspectorPlugin EditorInspectorPlugin

#define ObjectInspectorCategory EditorInspectorCategory
#define ObjectInspectorSection EditorInspectorSection
#define ObjectInspectorArray EditorInspectorArray
...
class EditorInspectorSection : public Container {
	...
	HashSet<String> section_folding;
	void _set_section_unfold(const String &p_section, bool p_unfolded, bool p_initializing = false);
	bool _is_section_unfolded(const String &p_section);
	const HashSet<String> &_get_section_folding() const { return section_folding; }
	void clear_section_folding() { section_folding.clear(); }
...
private:
	...
	bool use_doc_hints = false; // TODO: true
