...
///////////////////////////////////////////////////
/// \brief The ObjectInspectorDefaultPlugin class
///
class ObjectInspectorDefaultPlugin : public EditorInspectorPlugin {
	GDCLASS(ObjectInspectorDefaultPlugin, EditorInspectorPlugin);
